...
- (void)setKeyValues:(NSDictionary *)keyValues
{
    ...
    [self enumerateIvarsWithBlock:^(MJIvar *ivar, BOOL *stop) {
        ...
        if(![value isKindOfClass:[NSString class]]&&![value isKindOfClass:[NSArray class]]&&![value isKindOfClass:[NSMutableArray class]]&&![value isKindOfClass:[NSDictionary class]]&&![value isKindOfClass:[NSNull class]])
